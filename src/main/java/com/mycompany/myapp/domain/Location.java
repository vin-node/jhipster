...
public class Location implements Serializable {
    ...
    @OneToMany(mappedBy = "location")
    @JsonIgnore
    private Set<GeoCordinate> geoCordinates = new HashSet<>();
    ...
    public Set<GeoCordinate> getGeoCordinates() {
        return geoCordinates;
    }

    public Location geoCordinates(Set<GeoCordinate> geoCordinates) {
        this.geoCordinates = geoCordinates;
        return this;
    }

    public Location addGeoCordinate(GeoCordinate geoCordinate) {
        this.geoCordinates.add(geoCordinate);
        geoCordinate.setLocation(this);
        return this;
    }

    public Location removeGeoCordinate(GeoCordinate geoCordinate) {
        this.geoCordinates.remove(geoCordinate);
        geoCordinate.setLocation(null);
        return this;
    }

    public void setGeoCordinates(Set<GeoCordinate> geoCordinates) {
        this.geoCordinates = geoCordinates;
    }

...
export class CoordinatesComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Coordinates) {
        return item.id;
    }
    registerChangeInCoordinates() {
        this.eventSubscriber = this.eventManager.subscribe('coordinatesListModification', (response) => this.reset());
    }
